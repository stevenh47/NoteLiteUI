...
#  Jun 02, 2022 11:05:54 PM PDT  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    button $site_3_0.but50 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Button 
    vTcl:DefineAlias "$site_3_0.but50" "buttonAddTag" vTcl:WidgetProc "CardDisplayer" 1
    button $site_3_0.but51 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Button 
    vTcl:DefineAlias "$site_3_0.but51" "buttonDeleteTag" vTcl:WidgetProc "CardDisplayer" 1
