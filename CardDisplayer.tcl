...
#  May 26, 2022 05:38:39 PM PDT  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    vTcl:DefineAlias "$top.tex46" "TextTitle" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$top.fra48" "FrameTag" vTcl:WidgetProc "Toplevel1" 1
    ...
    vTcl:DefineAlias "$site_3_0.tex49" "TextTag" vTcl:WidgetProc "Toplevel1" 1
    button $site_3_0.but50 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Button 
    vTcl:DefineAlias "$site_3_0.but50" "ButtonAddTag" vTcl:WidgetProc "Toplevel1" 1
    button $site_3_0.but51 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Button 
    vTcl:DefineAlias "$site_3_0.but51" "ButtonDeleteTag" vTcl:WidgetProc "Toplevel1" 1
    place $site_3_0.tex49 \
        -in $site_3_0 -x 0 -relx 0.018 -y 0 -rely 0.364 -width 0 \
        -relwidth 0.117 -height 0 -relheight 0.436 -anchor nw \
        -bordermode ignore 
    place $site_3_0.but50 \
        -in $site_3_0 -x 0 -relx 0.771 -y 0 -rely 0.364 -width 47 -relwidth 0 \
        -height 24 -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but51 \
        -in $site_3_0 -x 0 -relx 0.881 -y 0 -rely 0.364 -width 47 -relwidth 0 \
        -height 24 -relheight 0 -anchor nw -bordermode ignore 
    label $top.lab52 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text 卡片ID： 
    vTcl:DefineAlias "$top.lab52" "LabelCardId" vTcl:WidgetProc "Toplevel1" 1
    text $top.tex53 \
        -background white -font TkTextFont -foreground black -height 214 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -insertbackground black -selectbackground #c4c4c4 \
        -selectforeground black -width 544 -wrap word 
    $top.tex53 configure -font "TkTextFont"
    $top.tex53 insert end text
    vTcl:DefineAlias "$top.tex53" "TextContent" vTcl:WidgetProc "Toplevel1" 1
    button $top.but47 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Save 
    vTcl:DefineAlias "$top.but47" "ButtonSave" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.tex46 \
    ...
    place $top.tex53 \
        -in $top -x 0 -relx 0.033 -y 0 -rely 0.333 -width 0 -relwidth 0.907 \
